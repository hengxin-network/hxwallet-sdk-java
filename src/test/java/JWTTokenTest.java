...
public class JWTTokenTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(TestUtil.pemTestKey);
            System.out.println(TestUtil.testPublicKey2);
...
//            System.out.println();
            ...
            HXJwtVerifyMaterial verifyMaterial = new HXJwtVerifyMaterial().setRequestMethod("POST")
                    .setBody(jwtTestBody.getBytes())
                    .setRawJwtString(jwtRawStr)
                    .setUrl(HXUtils.buildUrlPathWithQueries("/bank/test", null));
