...
public class HXDefaultHttpClient implements IHXHttpClient {
    ...
    @Override
    public HXResponse<String> post(String path, Map<String, String> queries, Map<String, String> headers, Map<String, Object> body) {
        try {
            String urlPath = HXUtils.buildUrlPathWithQueries(path, queries);
            URL url = HXUtils.packageRequestUrl(this, urlPath);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            ...
            if (body != null) {
                ...
                writer.write(HXUtils.optToJson(body));
                writer.flush();
                writer.close();
            }
    ...
    @Override
    public HXResponse<String> postFile(String path, Map<String, String> queries, Map<String, String> headers, Map<String, String> body, HXFileHolder file) {
        try {
            String boundary = file.getBoundary();
            String urlPath = HXUtils.buildUrlPathWithQueries(path, queries);
            URL url = HXUtils.packageRequestUrl(this, urlPath);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            if (headers != null) {
            ...
            writer.write(HXUtils.packageFormData(body, file));
            writer.flush();
            writer.close();
